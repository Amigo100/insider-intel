    ...
    items: [
      {
        ...
        answer:
          'Absolutely. We use bank-grade 256-bit SSL encryption for all data transmission. Your personal information is stored securely and never shared with third parties. We follow SOC 2 security standards and regularly audit our systems. Your payment information is handled by Stripe and never touches our servers.',
      },
      {
